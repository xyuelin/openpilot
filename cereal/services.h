...
static std::map<std::string, service> services = {
  ...
  { "frogpilotCarControl", {"frogpilotCarControl", 8062, true, 100, 10}},
  { "frogpilotCarState", {"frogpilotCarState", 8063, true, 100, 10}},
  { "frogpilotDeviceState", {"frogpilotDeviceState", 8064, true, 2, 1}},
  { "frogpilotNavigation", {"frogpilotNavigation", 8065, true, 1, 10}},
  { "frogpilotPlan", {"frogpilotPlan", 8066, true, 20, 5}},
  { "uiDebug", {"uiDebug", 8067, true, 0, 1}},
  { "testJoystick", {"testJoystick", 8068, true, 0, -1}},
  { "roadEncodeData", {"roadEncodeData", 8069, false, 20, -1}},
  { "driverEncodeData", {"driverEncodeData", 8070, false, 20, -1}},
  { "wideRoadEncodeData", {"wideRoadEncodeData", 8071, false, 20, -1}},
  { "qRoadEncodeData", {"qRoadEncodeData", 8072, false, 20, -1}},
  { "livestreamWideRoadEncodeIdx", {"livestreamWideRoadEncodeIdx", 8073, false, 20, -1}},
  { "livestreamRoadEncodeIdx", {"livestreamRoadEncodeIdx", 8074, false, 20, -1}},
  { "livestreamDriverEncodeIdx", {"livestreamDriverEncodeIdx", 8075, false, 20, -1}},
  { "livestreamWideRoadEncodeData", {"livestreamWideRoadEncodeData", 8076, false, 20, -1}},
  { "livestreamRoadEncodeData", {"livestreamRoadEncodeData", 8077, false, 20, -1}},
  { "livestreamDriverEncodeData", {"livestreamDriverEncodeData", 8078, false, 20, -1}},
  { "customReservedRawData0", {"customReservedRawData0", 8079, true, 0, -1}},
  { "customReservedRawData1", {"customReservedRawData1", 8080, true, 0, -1}},
  { "customReservedRawData2", {"customReservedRawData2", 8081, true, 0, -1}},
};
#endif
