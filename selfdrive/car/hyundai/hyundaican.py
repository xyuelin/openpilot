...
def create_acc_commands(packer, enabled, accel, upper_jerk, idx, hud_control, set_speed, stopping, long_override, use_fca, lat_active):
  commands = []

  scc11_values = {
    "MainMode_ACC": 1 if lat_active else 0,
